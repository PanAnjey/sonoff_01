...
//       *p = 0;   
   ...
   strcpy(EC_Config.STA_SSID, SSID_NAME);
   strcpy(EC_Config.STA_PASS, SSID_PASS);
   strcpy(EC_Config.AP_SSID, AP_SSID_NAME);
   strcpy(EC_Config.AP_PASS, AP_SSID_PASS);
   strcpy(EC_Config.HTTP_PASS, PASW);
   EC_Config.IP[0]      = 192;   
   EC_Config.IP[1]      = 168;   
   EC_Config.IP[2]      = 1;     
   EC_Config.IP[3]      = 13;
